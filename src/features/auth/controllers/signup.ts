...
import { IAuthDocument, ISignUpData } from '@auth/interfaces/auth.inteface';
...
export class SignUp {
  ...
  public async create(req: Request, res: Response): Promise<void> {
    ...
    userDataForCache.profilePicture = `https://res.cloudinary.com/dfapum2fd/image/upload/v${result.version}/${userObjectId}`;
